#!/usr/bin/env python3
"""Generate Player Trade's mod menu icon: the vanilla emerald.
...
OUT = os.path.join(HERE, "src/main/resources/assets/player-trade/icon.png")
...
def build_icon():
    """The mod ships no textures of its own. An emerald is the game's own
    shorthand for trading, so that is the icon."""
    return scale(vanilla("item/emerald.png"), 8)
